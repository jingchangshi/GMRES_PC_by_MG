...
solver: main.f90 dtype.o petsc_solver.o jacobi_solver.o multigrid_solver.o petsc_shell_preconditioner.o
	${FC} ${FFLAGS} -o solver main.f90 dtype.o petsc_solver.o jacobi_solver.o multigrid_solver.o petsc_shell_preconditioner.o ${PETSc_FLAGS}
dtype.o: dtype.f90
...
run21:
	./solver -n 1280 -solver_type 2 -maxits 1000
run31:
